...
<html>
   <head>
  	<title>CO2 - Line CO2 Chart - Data from a database</title>
   ...
   <body>
  	<?php
        ...
        $strQuery = "SELECT Timestamp,CO2 FROM MCP3008 WHERE Timestamp > DATE_SUB(NOW(), INTERVAL 200 HOUR) AND Timestamp <= NOW()";
     	...
     	if ($result) {
        	...
        	$arrData = array(
        	    "chart" => array(
                  "caption" => "CO2 readings for the last 48 hours",
		  "xaxisname" => "Timestamp",
		  "yaxisname" => "C02(PPM)",
                  "paletteColors" => "#800080",
                  "bgColor" => "#ffffff",
                  "borderAlpha"=> "20",
                  "canvasBorderAlpha"=> "0",
