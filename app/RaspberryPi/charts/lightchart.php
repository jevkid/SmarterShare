...
<div class = "container">
    ...
    <div class = "data-chart">
        ...
        <div class = "chart-options-pi">
            ...
            <a class = "btn2" href = "lightchart.php">Light</a>
...
?>
  	<?php
        ...
        $strQuery = "SELECT * FROM LIGHT WHERE Timestamp > DATE_SUB(NOW(), INTERVAL 72 HOUR) AND Timestamp <= NOW()";
     	...
     	if ($result) {
        	...
        	$arrData = array(
        	    "chart" => array(
                  "caption" => "Light Intensity readings for the last 48 hours",
		  "xaxisname" => "Timestamp",
		  "yaxisname" => "Light(lx)",
                  "paletteColors" => "#FFFF00",
                  "bgColor" => "#ffffff",
                  "borderAlpha"=> "20",
                  "canvasBorderAlpha"=> "0",
	...
	// Push the data into the array
        ...
        $columnChart = new FusionCharts("area2d", "myFirstChart" , 600, 300, "chart-container", "json", $jsonEncodedData);
