...
<div class = "container">
    ...
    <div class = "data-chart">
        ...
        <div class = "chart-options-pi">
            ...
            <a class = "btn2" href = "mq135chart.php">MQ135: Air Quality</a>
...
?>
  	<?php
        ...
        $strQuery = "SELECT Timestamp,MQ135 FROM MCP3008 WHERE Timestamp > DATE_SUB(NOW(), INTERVAL 200 HOUR) AND Timestamp <= NOW()";
     	...
     	if ($result) {
        	...
        	$arrData = array(
        	    "chart" => array(
                  "caption" => "MQ135 readings for the last 48 hours",
		  "xaxisname" => "Timestamp",
		  "yaxisname" => "MQ135(PPM)",
                  "paletteColors" => "#6AA121",
                  "bgColor" => "#ffffff",
                  "borderAlpha"=> "20",
                  "canvasBorderAlpha"=> "0",
