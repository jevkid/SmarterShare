...
<div class = "container">
    ...
    <div class = "data-chart">
        ...
        <div class = "chart-options-pi">
            ...
            <a class = "btn2" href = "mq2chart.php">MQ2: Air Quality</a>
...
?>
  	<?php
        ...
        $strQuery = "SELECT Timestamp,MQ2 FROM MCP3008 WHERE Timestamp > DATE_SUB(NOW(), INTERVAL 200 HOUR) AND Timestamp <= NOW()";
     	...
     	if ($result) {
        	...
        	$arrData = array(
        	    "chart" => array(
                  "caption" => "MQ2 readings for the last 48 hours",
		  "xaxisname" => "Timestamp",
		  "yaxisname" => "MQ2(PPM)",
                  "paletteColors" => "#C68E17",
                  "bgColor" => "#ffffff",
                  "borderAlpha"=> "20",
                  "canvasBorderAlpha"=> "0",
