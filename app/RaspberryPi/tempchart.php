...
<html>
   <head>
  	<title>DHT22 - Line Temperature Chart - Data from a database</title>
   ...
   <body>
  	<?php
        ...
        $strQuery = "SELECT * FROM DHT22 WHERE Timestamp > DATE_SUB(NOW(), INTERVAL 72 HOUR) AND Timestamp <= NOW()";
     	...
     	if ($result) {
        	...
        	$arrData = array(
        	    "chart" => array(
                  "caption" => "Temperature readings for the last 48 hours",
		  "xaxisname" => "Timestamp",
		  "yaxisname" => "Temp(Celcius)",
